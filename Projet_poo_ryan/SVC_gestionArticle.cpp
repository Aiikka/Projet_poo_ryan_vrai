...

{
    ...
    void CL_svc_gestionARTICLE::ajouter(String^ nomarticle, String^ design , int reap, int taux,int cout)
    {
 ...
 /*     this->client->setPrenom(prenom);
    ...
    void CL_svc_gestionARTICLE::CL_svc_gestionARTICLE::modifier(int id_article, String^ nomarticle, String^ design, int reap, int taux , int cout)
    {
