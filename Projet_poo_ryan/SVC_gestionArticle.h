...

{
    ...
    public:
        ...
        void ajouter(String^ nomarticle, String^ design, int reap, int taux,int cout);

        void modifier(int id_article, String^ nomarticle, String^ design, int reap, int taux,int cout);
